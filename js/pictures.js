...
;(function($){
    $.fn.pgwSlideshow = function(options) {
        var defaults = {
            ...
            maxHeight : null,
            len:($('.pgwSlideshow>li img').length),
        ...
        var setup = function() {
            ...
            var elementId = 1;
            //console.log( pgwSlideshow.plugin.find('.ps-list > ul > li:last-child a img').attr('data-num') );
            if( pgwSlideshow.plugin.find('.ps-list > ul > li:last-child a img').attr('data-num')!==undefined ){
                pgwSlideshow.plugin.find('.ps-list > ul > li:last-child').css('width',0);
                pgwSlideshow.plugin.find('.ps-list > ul > li:last-child').css('height',0);
                pgwSlideshow.plugin.find('.ps-list > ul > li:last-child').css('opacity',0);
            }
        ...
        var getElement = function(obj) {
            ...
            var elementNum = obj.find('img').attr('data-num');
            if ((typeof elementNum != 'undefined') && (elementNum != '')) {
                element.num = elementNum;
            }
            return element;
        };
        // Finish element
        ...
        var fadeElement = function(element) {
            ...
            if( pgwSlideshow.plugin.find('.ps-list > ul > li:last-child a img').attr('data-num')===undefined ){
                elementContainer.find('li:last-child a').prepend('<span class="adv"></span>');
            }
        ...
        var displayElement = function(elementId, apiController, direction) {
            ...
            if (typeof pgwSlideshow.plugin.find('.ps-caption').fadeOut == 'function') {
                pgwSlideshow.plugin.find('.ps-caption,.ps-len').fadeOut(pgwSlideshow.config.transitionDuration / 2);
            } else {
                pgwSlideshow.plugin.find('.ps-caption,.ps-len').hide();
            }
